...
public class SPEDContribM610 extends SPEDRegister {
   ...
   * # valor do total dos ajustes de acréscimo da base de cálculo da contribuição a que se refere o Campo 04 N - 02 S.
   *
   * @param r05_VL_AJUS_ACRES_BC_COFINS the new valor do total dos ajustes de acréscimo da base de cálculo da contribuição a que se refere o Campo 04 N - 02 S
   */
   ...
   * # valor do total dos ajustes de redução da base de cálculo da contribuição a que se refere o Campo 04 N - 02 S.
   *
   * @param r06_VL_AJUS_REDUC_BC_COFINS the new valor do total dos ajustes de redução da base de cálculo da contribuição a que se refere o Campo 04 N - 02 S
   */
   ...
   * # alíquota do COFINS (em percentual) N 008 04 N.
   *
   * @param r08_ALIQ_COFINS the new alíquota do COFINS (em percentual) N 008 04 N
   */
   ...
   * # quantidade – Base de cálculo COFINS N - 03 N.
   *
   * @param r09_QUANT_BC_COFINS the new quantidade – Base de cálculo COFINS N - 03 N
   */
   ...
   * # alíquota do COFINS (em reais) N - 04 N.
   *
   * @param r10_ALIQ_COFINS_QUANT the new alíquota do COFINS (em reais) N - 04 N
   */
