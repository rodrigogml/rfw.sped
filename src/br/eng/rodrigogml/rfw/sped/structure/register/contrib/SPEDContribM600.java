...
/**
 * Description: REGISTRO M600: CONSOLIDAÇÃO DA CONTRIBUIÇÃO PARA A SEGURIDADE SOCIAL - COFINS DO PERÍODO.<br>
 *
 * @author Rodrigo GML
...
public class SPEDContribM600 extends SPEDRegister {
  ...
  public SPEDContribM600(SPEDFile spedFile) {
    super(spedFile);
  }
  ...
  /**
   * Valor Total da Contribuição Não Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 01, 02, 03, 04, 32 e 71) N - 02 S
   */
  @SPEDField(maxLength = 20, decimals = 2, required = true)
  private BigDecimal r02_VL_TOT_CONT_NC_PER = null;

  /**
   * Valor do Crédito Descontado, Apurado no Próprio Período da Escrituração (recuperado do campo 14 do Registro M500) N - 02 S
   */
  @SPEDField(maxLength = 20, decimals = 2, required = true)
  private BigDecimal r03_VL_TOT_CRED_DESC = null;

  /**
   * Valor do Crédito Descontado, Apurado em Período de Apuração Anterior (recuperado do campo 13 do Registro 1500) N - 02 S
   */
  @SPEDField(maxLength = 20, decimals = 2, required = true)
  ...
  /**
   * Valor Total da Contribuição Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 31, 32, 51, 52, 53, 54 e 72) N - 02 S
   */
  @SPEDField(maxLength = 20, decimals = 2, required = true)
  ...
  /**
   * Recupera o valor Total da Contribuição Não Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 01, 02, 03, 04, 32 e 71) N - 02 S.
   *
   * @return the valor Total da Contribuição Não Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 01, 02, 03, 04, 32 e 71) N - 02 S
   */
  ...
  /**
   * Define o valor Total da Contribuição Não Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 01, 02, 03, 04, 32 e 71) N - 02 S.
   *
   * @param r02_VL_TOT_CONT_NC_PER the new valor Total da Contribuição Não Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 01, 02, 03, 04, 32 e 71) N - 02 S
   */
  ...
  /**
   * Recupera o valor do Crédito Descontado, Apurado no Próprio Período da Escrituração (recuperado do campo 14 do Registro M500) N - 02 S.
   *
   * @return the valor do Crédito Descontado, Apurado no Próprio Período da Escrituração (recuperado do campo 14 do Registro M500) N - 02 S
   */
  ...
  /**
   * Define o valor do Crédito Descontado, Apurado no Próprio Período da Escrituração (recuperado do campo 14 do Registro M500) N - 02 S.
   *
   * @param r03_VL_TOT_CRED_DESC the new valor do Crédito Descontado, Apurado no Próprio Período da Escrituração (recuperado do campo 14 do Registro M500) N - 02 S
   */
  ...
  /**
   * Recupera o valor do Crédito Descontado, Apurado em Período de Apuração Anterior (recuperado do campo 13 do Registro 1500) N - 02 S.
   *
   * @return the valor do Crédito Descontado, Apurado em Período de Apuração Anterior (recuperado do campo 13 do Registro 1500) N - 02 S
   */
  ...
  /**
   * Define o valor do Crédito Descontado, Apurado em Período de Apuração Anterior (recuperado do campo 13 do Registro 1500) N - 02 S.
   *
   * @param r04_VL_TOT_CRED_DESC_ANT the new valor do Crédito Descontado, Apurado em Período de Apuração Anterior (recuperado do campo 13 do Registro 1500) N - 02 S
   */
  ...
  /**
   * Recupera o valor Total da Contribuição Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 31, 32, 51, 52, 53, 54 e 72) N - 02 S.
   *
   * @return the valor Total da Contribuição Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 31, 32, 51, 52, 53, 54 e 72) N - 02 S
   */
  ...
  /**
   * Define o valor Total da Contribuição Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 31, 32, 51, 52, 53, 54 e 72) N - 02 S.
   *
   * @param r09_VL_TOT_CONT_CUM_PER the new valor Total da Contribuição Cumulativa do Período (recuperado do campo 13 do Registro M610, quando o campo “COD_CONT” = 31, 32, 51, 52, 53, 54 e 72) N - 02 S
   */
  ...
  /**
   * Recupera o rEGISTRO M605: COFINS A RECOLHER – DETALHAMENTO POR CÓDIGO DE RECEITA.
   *
   * @return the rEGISTRO M605: COFINS A RECOLHER – DETALHAMENTO POR CÓDIGO DE RECEITA
   */
  ...
  /**
   * Recupera o rEGISTRO M610: DETALHAMENTO DA CONTRIBUIÇÃO PARA A SEGURIDADE SOCIAL - COFINS DO PERÍODO.
   *
   * @return the rEGISTRO M610: DETALHAMENTO DA CONTRIBUIÇÃO PARA A SEGURIDADE SOCIAL - COFINS DO PERÍODO
   */
