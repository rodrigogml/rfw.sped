...
public class SPEDContrib0500 extends SPEDRegister {
  ...
  /**
   * 09 CNPJ_EST CNPJ do estabelecimento, no caso da conta informadano campo COD_CTA ser específica de um estabelecimento. N 014* - N
   */
  ...
  /**
   * Recupera o 08 COD_CTA_REF Código da conta correlacionada no Plano de Contas Referenciado, publicado pela RFB. C 060 - N.
   *
   * @return the 08 COD_CTA_REF Código da conta correlacionada no Plano de Contas Referenciado, publicado pela RFB
   */
  ...
  /**
   * Define o 08 COD_CTA_REF Código da conta correlacionada no Plano de Contas Referenciado, publicado pela RFB. C 060 - N.
   *
   * @param r08_COD_CTA_REF the new 08 COD_CTA_REF Código da conta correlacionada no Plano de Contas Referenciado, publicado pela RFB
   */
  ...
  /**
   * Recupera o 09 CNPJ_EST CNPJ do estabelecimento, no caso da conta informadano campo COD_CTA ser específica de um estabelecimento. N 014* - N.
   *
   * @return the 09 CNPJ_EST CNPJ do estabelecimento, no caso da conta informadano campo COD_CTA ser específica de um estabelecimento
   */
  ...
  /**
   * Define o 09 CNPJ_EST CNPJ do estabelecimento, no caso da conta informadano campo COD_CTA ser específica de um estabelecimento. N 014* - N.
   *
   * @param r09_CNPJ_EST the new 09 CNPJ_EST CNPJ do estabelecimento, no caso da conta informadano campo COD_CTA ser específica de um estabelecimento
   */
